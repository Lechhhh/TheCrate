...
app.post('/api/register', async (req, res) => {
    ...
    try {
        ...
        res.json({ success: false, msg: "Wystąpił błąd po stronie API pocztowego." });
    }
});
...
app.post('/api/chat', async (req, res) => {
    ...
    2. MASZ ABSOLUTNY ZAKAZ zmyślania faktów i wymyślania tytułów piosenek! Jeśli nie znasz konkretnego utworu z podziemia, napisz po prostu, że ciężko wskazać konkretny numer i trzeba szukać na Soundcloudzie.
    3. Używaj naturalnych zwrotów (np. beat, podziemie, flow, track).
    4. CAŁKOWITY ZAKAZ boomerskiego slangu (zero słów typu: drip, swag, mordo, tissue, smack).
    5. Żadnego sztywnego, naukowego języka. Odpowiadaj krótko (max 3 zdania).`;
